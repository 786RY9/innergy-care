  ...
  return (
    <div className="pt-32 pb-24 bg-soft-white min-h-screen flex items-center justify-center px-6">
      ...
      >
        ...
        >
          We are currently drafting our Privacy Policy to ensure it fully reflects our commitment to protecting your personal health information.
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          This page will be available soon. For any privacy-related questions, please reach out to us at{" "}
